...
from .vision_utils import (load_audio_qwen, load_batch, load_image, load_video_cogvlm2, load_video_internvl,
                           ...
                           transform_image)
from albumentations import Compose, FancyPCA, HueSaturationValue, OneOf, ImageCompression, GaussNoise, \
...
class LlavaHfTemplate(Template):
    ...
    def _encode(self, example: Dict[str, Any]) -> Tuple[Dict[str, Any], Dict[str, Any]]:
        ...
        if self.data_aug:
            ...
            images = [Image.fromarray(self.aug(image=np.array(images[0]))['image'])]
